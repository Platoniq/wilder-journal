...
{% author { "name": "Yanina Welp", "position": "Miembro del equipo del [Albert Hirschman Centre on Democracy](https://graduateinstitute.ch/democracy). Cofundadora de la [Red de Politólogas ](https://www.nosinmujeres.com/)y miembro de los consejos del [Observatorio de Reformas Políticas](https://www.reformaspolíticas.org/), el [Real Instituto Elcano](https://www.realinstitutoelcano.org/) y el [CIEPS](https://cieps.org.pa/)", "image": { "path": "/media/olivier.jpg", "alt": "Olivier Schulbaum, co-fundador de la Fundación Platoniq" }, "description": "Especializada en el estudio de la democracia y la participación 
