...
Diego’s interest in embeddings—as a way to navigate what he calls the “collective semantic chaos” generated by participation—stems precisely from a facilitation problem: how to move from the intensity of grassroots activism to the abstraction of large-scale network analysis without losing people along the way. Traditional visualizations offered him spectacular maps of interactions on Twitter, but they remained limited when it came to truly understanding what was being said and what collective concerns were emerging. 

{% quote %}What interests me about this technique is flattening everything out and seeing what emerges within the semantic space.{% endquote %}

For Diego, embeddings offer a possible way to navigate this complexity. They allow proposals to be temporarily placed within the same semantic field, enabling us to observe which themes, tensions, and collective concerns begin to emerge in the participatory landscape. Instead of pigeonholing contributions into predefined administrative categories, these systems aim to bring emerging thematic affinities to light, allowing ideas, concerns, affections, and conflicts to cluster through semantic affinity rather than institutional design.
