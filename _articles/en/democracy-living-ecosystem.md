...
The vision there is that hopefully we can start a few languages, maybe one from each major populated center or sub-region globally, work with partners there to collect these different linguistic artifacts.

We're treating them like pot shards, and then trying to build archives around them and trying to make sense of where these things come from: what land, what people on those lands, which context, which reasons, and then ultimately, are these viable ideas? That was a big critique earlier on in this project. Quite a few people have said, “This is crazy.” It could be a deliberation process in itself, I would say.
