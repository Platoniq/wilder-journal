...
{% gallery { "simple": false, "images": [{"path":"/media/participatorybudget.png","alt":"Participatory Budgets","caption":"(1) Citizens propose ideas for projects (2) The Administration studies and selects ideas, and formalizes projects (3) Citizens vote (4) The Administration implements winning projects","credits":"Comunicaciones EVoting"}] } %}

In **matchfunding**, citizens present and execute an initiative through a crowdfunding campaign the costs of which are covered equally between donors and the Administration.
...
{% gallery { "simple": false, "images": [{"path":"/media/democratic-funding-moustache.png","credits":"Take the Money and Run (Woody Allen)","caption":"Representation of project promoters avoiding their responsibility in the execution of the project"}] } %}
...
{% gallery { "simple": false, "images": [{"path":"/media/cooking-democracy.jpeg","caption":"Cooking Democracy","credits":"Svetlana Malysheva"}] } %}
...
{% gallery { "simple": false, "images": [{"path":"/media/find-walfo-.png","caption":"Putting the focus on the people responsible for the project is as difficult as finding Wally","credits":"Martin Handford "}] } %}
...
{% gallery { "simple": false, "images": [{"path":"/media/feminismo-carlos-rodriguez-estacio.jpeg","caption":"20th century feminist struggles","credits":"Museum of London (Anonymous)"}] } %}
