...
* Petition platforms, such as Coworker.org, which allow individuals and groups to launch and join campaigns with the aim of improving their working conditions.
...
This article ends here, so if you are interested in knowing more, we invite you to continue learning about and reading the "\[Letter: Towards a feminist inter-union](https://www.pikaramagazine.com/2022/05/carta-hacia- una-intersindical-feminista/)" where it is expressed: We are convinced that feminism is an indisputable engine of change when it breaks down the boxes and puts at the center the concrete life of women, trans people, dissidents, communities in rebellion. That's why we want to be more. We want to multiply the plots of cooperation, mutual support, shared struggle between us.
