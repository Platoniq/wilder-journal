...
title: "Psychofancy, loneliness, and parasocial attachment: How can we envision
...
We live in a reality that has us constantly calling for regulation, but what we lack is the ability to enforce it; we must be able to compel compliance and, therefore, report and prosecute those who fail to do so.
...
I am strongly opposed to technological solutionism, and this is precisely the narrative that I would say the industry, above all, has promoted: this idea. On the other hand, it’s also said that technological solutionism only works if you’re part of that privileged minority who will have access to this technology that’s supposed to solve everything. I think we should ask a lot of questions, because “everything” is a very broad, very ambitious absolute. And, furthermore, I think it’s also positive that there are spheres of our lives and our existence that are free from technology. 

Believing that technology is something that falls upon me, magically, or that it is governed by natural laws I do not understand, perpetuates inequality in terms of power asymmetry and the capacity for agency to govern that technology. Forgetting that behind it all lies a creation made by people—and that, therefore, there can be a process of negotiation and social correction—is what I advocate for from a position of critical techno-optimism: to assert that the final say on what technology should be like, how we want to use it, and how we want to appropriate this technology must be human and, preferably, collective. Because if we approach this from an individual perspective, those with the capacity to govern technology are those with money and power—which is exactly what is happening now.
...
And I can give counterexamples. In other words, to me, social media platforms—which fragment us, isolate us, and trap us in echo chambers—are not examples of digital social innovation or social responsibility. Far from nurturing our connections—even though that was the original promise—what they do is trap us in echo chambers, in little echo boxes, where we’re not only stuck with the version of ourselves from x amount of time ago, when our data was collected, and it’s very hard to update that, but we’re also trapped in a very homogeneous landscape.

For me, responsible digital innovation is socially responsible not only when it complies with security and privacy standards. It is responsible when it upholds the 1948 Universal Declaration of Human Rights; thus, fundamental rights are guaranteed. But not only that, because while fundamental human rights are individual in nature, we actually need community to exist. We have always needed it and will continue to need it. Therefore, this social responsibility—which has now become a very business-oriented term that companies have used for many years—is what places the common good at the center of technological development.
