...
{% quote %}When women are given autonomy, you have to offer them a safe place, an encrypted place, a place where they will not be the ones going to court.{% endquote %}
...
On 25 November, I published an [opinion](https://www.publico.es/opinion/columnas/nuestro-relato-acto-politico-todas-victimas-silencio.html) in which I said: ‘Our narrative is a political act to blow up the institutions that have imposed silence on the majority of the population: women, the republican movement, migrants, victims of the Catholic Church, the LGTBIQ+ community, those tortured in democracy...’ 
...
{% quote %}At this moment, we can all create an irrefutable collective narrative.{% endquote %}
...
### You have spoken in other contexts about the idea of “truth”. Legal truth is often demanded, but you advocate a kind of narrative truth. Why is the judicial system not enough to heal or understand sexual violence? What does this narrative contribute? Why is it necessary to go further?
...
### Social media revictimises and censors keywords related to sexual violence, as has happened to you with Instagram, but at the same time allows hate speech. Do you think this type of algorithmic censorship is a new form of violence against women? How does La Nuestra combat this dynamic?
...
{% quote %}This archive we are building needs your peace, it needs your tranquillity.{% endquote %}
...
{% questions { "items": [{"question":"Do you want to be a comother of \"La Nuestra\""}] } %}
