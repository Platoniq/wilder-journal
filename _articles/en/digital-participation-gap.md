...
**Digital skills** are those that allow us to use, appropriate and participate in the design and development of new technologies. In this sense, unequal access to such skills — digital literacy— conditions women’s position in the digital world, and they are often relegated to the role of mere recipients. In the article “Digital gender gap: women and new technologies” (3), Monica Arenas affirms that “*not only does inequality break with equal access to knowledge, but it is necessary to position women in the process of creating it*”, and adds that to balance the balance “*it is necessary that women become users, creators and transmitters of information and knowledge through new technologies*”.
