...
{% quote { "author": "Malcolm Noonan T. D., Minister for Biodiversity, Ireland" } %}The participative process that they designed is, I believe, replicable across all areas of public policy where the views of children and young people are sought. We should be doing much more of this. To say that they had an impact on public policy making would be an understatement{% endquote %}
