...
title: Can Youth Deliberation Inoculate Democracy? Youth deliberation,
...
description: Petra Guasti is Associate Professor of Democratic Theory at Charles
  ...
  populism, and citizen participation, with particular attention to democratic
...
One of the most important design choices we made was to allow participants themselves to define the agenda. In our earlier deliberative forum (of [ideological opponents](https://www.authlib.eu/authlib-ideological-opponents-forum/)) we selected deliberately polarizing topics. But with the young people we wanted to see what happens when the agenda is set from the bottom up.
