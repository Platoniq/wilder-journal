...
description: La deliberación sin integridad carece de sentido. La democracia sin
  solidaridad es frágil.
...
cover:
  ...
  thumbnail: /media/articles/thumbnails/image01.jpg
  alt: Lucy J Parry
  credits: Lucy J Parry
  caption: Lucy J Parry
...
---
**Lucy J. Parry** es una teórica política y experta en innovación democrática cuyo trabajo tiende un puente entre la democracia deliberativa —tanto en la teoría como en la práctica— y la ética animal. Es coautora de un importante estudio sobre la [integridad deliberativa](https://deliberativeintegrityproject.org/) en la gobernanza mediante minipúblicos, en el que identifica riesgos sistémicos relacionados con la puesta en marcha, la ortodoxia en el diseño y un seguimiento deficiente. También forma parte del proyecto INSPIRE sobre espacios interseccionales de participación, donde dirigió el desarrollo del Marco de Capacidades Democráticas (DCF), y es cofundadora de «Animals in the Room», una red emergente de investigación y práctica que explora cómo los intereses y la agencia no humanos pueden integrarse de manera significativa en los sistemas democráticos.
...
LP: La rendición de cuentas y el seguimiento son fundamentales para esa idea del ciclo de vida. Deben planificarse desde el principio. Profesionales con experiencia nos contaron que se sintieron decepcionados por procesos iniciales en los que no hubo un seguimiento claro. Con el tiempo, como comunidad de práctica, las personas que dirigen y diseñan los «minipúblicos» se han vuelto bastante reflexivas y autocríticas, y van iterando y mejorando. Una lección clave es integrar la rendición de cuentas y el seguimiento en las conversaciones iniciales con los comisionados o convocantes. En la práctica, esto significa obtener [compromisos por adelantado](https://link.springer.com/article/10.1057/s41269-023-00329-z%23citeas) sobre qué se hará con las recomendaciones y asegurarse de que los comisionados [entiendan realmente lo que implica «gestionar las recomendaciones» en la práctica.](https://www.knoca.eu/quick-reads/follow-up-to-climate-assemblies)

{% quote %}Con el tiempo, como comunidad de práctica, las personas que dirigen y diseñan los «minipúblicos» se han vuelto bastante reflexivas y autocríticas, y van iterando y mejorando{% endquote %}

Sabemos por [otros trabajos sobre asambleas ciudadanas](https://www.knoca.eu/events/workshop-on-the-follow-up-to-climate-assemblies) que las administraciones públicas a menudo no saben cómo gestionar las recomendaciones: quién es responsable, cómo integrarlas en los procedimientos existentes, cómo traducirlas en instrumentos de política y cómo responder públicamente. Por lo tanto, debe haber claridad sobre cómo y cuándo responderán los comisionados, y cómo será el proceso de respuesta. La puntualidad es crucial.

Los mecanismos de rendición de cuentas también pueden integrarse en el propio diseño como procesos de seguimiento. Algunos ejemplos son los sistemas de seguimiento de políticas o las formas estructuradas de continuar el diálogo entre los miembros de la asamblea y los comisionados. [Tras la Asamblea Climática de Escocia](https://www.involve.org.uk/sites/default/files/uploads/docuemnt/Scotland%252527s%252520Climate%252520Assembly%252520-%252520Ongoing%252520Support.pdf), por ejemplo, un pequeño grupo de participantes recibió apoyo para trabajar específicamente en la rendición de cuentas y el seguimiento de la respuesta del Gobierno escocés. En South Yorkshire hubo un [proyecto de seguimiento de la Asamblea Climática de South Yorkshire](https://player.sheffield.ac.uk/events/climate-reassemblies) que involucró a un subgrupo de participantes en el trabajo en curso en torno a las recomendaciones.
...
{% quote %}los derechos humanos no negociables, por ejemplo, no deberían ser objeto de debate{% endquote %}
...
A veces las decisiones ya se han tomado y se recurre a un minipúblico para garantizar la legitimidad de forma retroactiva. Los minipúblicos pueden utilizarse para [sondear las respuestas del público o evaluar el apoyo a una política propuesta](https://journals.sagepub.com/doi/10.1177/0032329206288152), pero si la decisión ya está cerrada y no hay margen significativo para ejercer influencia, no se debería recurrir a ellos.
...
En algunos contextos, resulta totalmente inapropiado imponer el modelo de minipúblico. Hemos oído hablar de casos en los que se ha impuesto un minipúblico [a pesar de las dudas o la resistencia de las comunidades al método](https://researchsystem.canberra.edu.au/ws/portalfiles/portal/106351019/Report_Deliberative_Integrity.pdf). Eso socava la autonomía y la soberanía locales.
...
[Sen también hace hincapié en la deliberación democrática](https://www.tandfonline.com/doi/full/10.1080/14649880500120491) a la hora de identificar las capacidades: los grupos afectados deben deliberar sobre lo que tienen motivos para valorar. Esto contrasta con [la lista de capacidades centrales de Nussbaum](https://www.cambridge.org/core/books/women-and-human-development/58D8D2FBFC1C9E902D648200C4B7009E), que se presenta como más universal. Muchos autores, incluido Sen, sostienen que las capacidades varían según el contexto, la comunidad, las prioridades y las necesidades.
...
La representación en sí misma es un concepto complejo. Me influyó la [visión constructivista de Michael Saward](https://academic.oup.com/book/4669), que se centra en las reivindicaciones representativas. Según ese punto de vista, incluso si tu gato está físicamente en la habitación expresando preferencias, tú, como ser humano, sigues representando esas preferencias cuando las interpretas y las comunicas. La representación se vuelve más amplia que la representación sustantiva más formal, como un diputado que habla en nombre del gato en el parlamento.

{% quote %}Si tu gato está físicamente en la habitación expresando preferencias, tú, como ser humano, sigues representando esas preferencias cuando las interpretas y las comunicas{% endquote %}
...
En tercer lugar, la legitimidad procedimental: la equidad del proceso deliberativo o participativo a la hora de incluir de manera significativa consideraciones más allá de lo humano, y la medida en que la facilitación apoya la reflexividad y la «[orientación hacia el otro](https://www.tandfonline.com/doi/abs/10.1080/09644019908414460)», ya que orientarnos más allá de lo humano no es algo natural y debe cultivarse.
