...
title: "A favor de las identidades complejas: nuevas narrativas migrantes para
  la cohesión social [Policy Brief]"
...
Sobre esta premisa, los **Diálogos Migrantes** buscan ser un espacio de participación y escucha activa que utiliza la comunicación como excusa para generar impacto social. Utilizando como vehículo la creación de piezas audiovisuales, el proyecto se plantea como una experiencia de búsqueda y co-creación de nuevas formas de narrar sobre las temáticas asociadas a las personas migrantes en España, con la Fundación Platoniq como facilitadora. 

**Dayo Eseonu,** profesora en la universidad de Lancaster, [de quién publicamos una entrevista](https://journal.platoniq.net/es/wilder-journal-2/interviews/justice-afrofuturism-participatory-research/) nos advierte: ***“Una cosa que evito es lo que se conoce como porno del trauma o porno de la pobreza, donde se estudia a las personas como objetos. Las comunidades racialmente minoritarias tienen capacidad de acción y ya están hablando; el problema es que la gente a menudo no escucha”.*** En su caso, es el afrofuturismo el que viene utilizado como prisma de investigación, algo que le permite salirse de los marcos de dolor establecidos y plantear, gracias al antirracismo especulativo, nuevas formas de narrar y de narrarse.

Y es que los datos son los que son. En la línea del trabajo de Quim Brugué, de la Universidad Autónoma de Barcelona, [“Discriminación en el acceso a la vivienda. De qué hablamos y cómo combatirla”](https://seu-e.cat/documents/674390/8280911/DRET+NO+DISCRIMINACI%C3%93.pdf/96bdbff9-788b-4d26-82e5-54cf8678f3c5), Olot, 2021, el racismo inmobiliario está a la orden del día. El 72.5% de las inmobiliarias aceptan formas explícitas de discriminación por motivos racistas, si bien las personas migrantes no nacionalizadas en España suponen el 6.81% del total. Se acepta, y no se discute demasiado, que: el trato al cliente sea peor, que se soliciten más avales, que casi se doblen las exigencias de documentación, que se impongan cláusulas abusivas y precios fuera de mercado o que se ofrezcan menos viviendas con ascensor y más pequeñas.

Eso en lo que se refiere a la vivienda, en salud o en materia de justícia, las cifras tampoco mejoran. Sobre el [racismo sanitario](https://www.publico.es/sociedad/racismo-institucional-espana-complicado-migrantes-acceso-atencion-medica.html), al menos, cinco comunidades (Galicia, Madrid, Baleares, Canarias y Melilla) ponen trabas en el acceso a la sanidad pública a las mujeres embarazadas y a menores y en cuanto al racismo judicial, SOS Racisme viene repitiendo desde hace años una misma denuncia: ["siempre está presente la falta de credibilidad que los operadores jurídicos otorgan a las personas inmigrantes"](https://sosracisme.org/la-invisibilizacion-del-racismo-en-el-sistema-judicial/).

En definitiva, hablar de racismo sistémico no es quedarnos cortos. Y, ante ello, hace falta darle la vuelta a la narrativa.
...
{% file { "title": "Madres migrantes: triple vulnerabilidad y derecho a una vida digna [Policy Brief]", "info": "Policy Brief", "file": "media/pb-triple-vulnerabilidad_esp.pdf", "image": "/media/captura-de-pantalla-2025-12-01-a-las-13.05.16.png", "button_text": "Descarga", "button_icon": "icon-download", "alt_color": false } %}
