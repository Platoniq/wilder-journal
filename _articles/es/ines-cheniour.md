...
3. and we develop open training for individuals as well, not customized.

### And what do you teach?

Well, it's a lot of customization. I start trying to understand what is the need of the target group and then adapt the design thinking methodology accordingly. Sometimes, I negotiate the methodology with the specific client, I ask them: should we focus more on the mindset and tools or more on how we use design thinking methods for a specific topic, for example how to develop team cohesion and resilience? So it depends, design thinking is always the structure that we use. We did a big research about what are the competences that design thinking can help develop, so we know that it can help a lot develop creativity, effectiveness, etc. Today for example we apply these methodologies to help career design, business definition, life and personal growth.
