...
En lugar de hundirme en la depresión y en todo lo que ocurrió, quise celebrar su legado. Traté de conectar con ese grupo demográfico. Así nació el proyecto: ¿cómo hacer algo no solo para mí, sino también para el mundo? Si iba a usar mi arte como terapia, ¿cómo compartir ese mensaje para hablarle a alguien más, para tocarle? Esa fue la conversación inicial conmigo mismo. Luego se convirtió en una conversación sobre inclusión, edadismo, el relato sobre el envejecimiento. Fui profundizando en la investigación, en el porqué, y en cómo cambiar la percepción de cómo nos vemos a nosotros mismos y a las personas mayores. A partir de ahí todo fue creciendo.
...
Sentí que había un vacío, un problema: conectar a la generación joven con la mayor. Había una desconexión. Así que me pregunté: ¿cómo unir tecnología, moda y confianza? Fue genial ver que podía funcionar: no hay división, hay combinación. No necesitas tener cierta edad para ser bello. La belleza existe. ¿Quién la define? Tengo claro que debería ser lo que tú digas. Ese cambio es lo que intento con esta serie.
...
Y no solo utilizo IA, también paso por otros programas, según lo que quiero contar. La IA es una parte del proceso, una más de las herramientas.
