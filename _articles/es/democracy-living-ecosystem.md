...
Así pues, estamos observando bastante de esta sensibilidad en los principales programas de subvenciones, en las ONG y en las OIG. Existe esa tensión de largo alcance. Creo que se le da demasiada importancia a esta tensión entre, por ejemplo, los teóricos por un lado, y los empiristas o estadísticos por el otro. Siempre estamos aprendiendo unos de otros. Los teóricos, por ejemplo, se quejan constantemente de las limitaciones de las variables. Los empiristas se quejan constantemente de que una variable no puede abarcarlo todo, o de que no puede haber 10 000 variables. Así que lo intentamos en ese ámbito, pero todo eso queda en un segundo plano.

{% quote %}Creo que no es de extrañar que haya más gente que celebre la profundidad de Monkey D. Luffy de One Piece en lugar de la teoría de la justicia de John Rawls {% endquote %}
