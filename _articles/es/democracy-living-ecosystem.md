...
**Jean-Paul:** Oh, fue vergonzosamente tarde. Como sabes, la mayoría de nosotros —y me cuesta mucho pensar en programas de posgrado, en cualquier tradición de estudios sobre la democracia, que ofrezcan un estudio tan abierto y programático— podemos llamarlo un enfoque lingüístico, un enfoque epistemológicamente incierto o uno que celebra las diferencias ontológicas y, en particular, las difusiones. Pero ya llegaremos a eso.

Así pues, estos programas de posgrado siguen obsesionados con la idea de que la democracia parece haber significado siempre algo coherente para la gran mayoría de la gente. De hecho, mucha gente tiene ese extraño apego al universalismo, que, como sabemos por Castro-Gómez y otros, resulta muy difícil de mantener como postura defendible si se adopta, ya sabes, un enfoque honesto y abierto sobre lo que es, ha sido y podría ser la democracia a lo largo del tiempo y el espacio, como mínimo.

Y la cosa se complica aún más si empiezas a pensar en los significados de la democracia entre individuos y grupos, e incluso entre especies. En resumen, creo que seguimos formándonos en gran medida de una manera que funciona bastante bien para servir, por ejemplo, a los intereses de… y no es que sea necesariamente algo malo. Tenemos una especie de camarilla malvada o cohorte de Estados, multimillonarios, «Moldbugs» o lo que sea que intentan controlar los discursos. No es así en absoluto. Es solo que, ya sabes, hay una serie de países a los que les gusta autodenominarse democracias liberales —entre comillas— «procedimentalmente justas», «institucionalmente sólidas», etc., y quieren que la gente proteja eso, que lo defienda, pero quizá no con demasiada firmeza.

Así pues, estamos observando bastante de esta sensibilidad en los principales programas de subvenciones, en las ONG y en las OIG. Existe esa tensión de larga data. Creo que se le da demasiada importancia a esta tensión entre, por ejemplo, los teóricos —y utilizo las comillas— por un lado, y los empiristas o estadísticos por el otro. Siempre estamos aprendiendo unos de otros. Los teóricos, por ejemplo, se quejan constantemente de las limitaciones de las variables. Los empiristas se quejan constantemente de que una variable no puede abarcarlo todo, o de que no puede haber 10 000 variables. Así que lo intentamos en ese ámbito, pero todo eso queda en un segundo plano.
...
Y lo que es más importante, esto salió a colación hace solo unos días: estamos hablando de estas cuestiones sobre por qué hay personas tan dominantes, figuras dominantes, que siguen apareciendo una y otra y otra vez en el llamado «archivo de la democracia», ¿verdad? Marx, Arendt, Rawls, Habermas. Es bastante difícil seguir volviendo a estas figuras y defendiéndolas porque, en muchos sentidos, crearon teorías que eran muy exclusivas y excluyentes, muy autorreferenciales.

Creo que no es de extrañar que haya más gente que celebre, por ejemplo, la profundidad de, digamos, Monkey D. Luffy de One Piece, ya sabes, en lugar de, por ejemplo, la teoría de la justicia de John Rawls, por no hablar de los demás libros.
...
Así que nos damos cuenta de que, en algún momento —diría que quizá Arnais lo expresa mejor—, en los años 60 o 70 más o menos, la aritmética, la estadística, las variables estrictas y cerradas, las preguntas en juego. Ya sabes, no te atreves a cambiar una pregunta en una encuesta. Vaya, intenta hacer eso en algo en lo que esté involucrada Pippa Norris. Les vuelve locos.

Pero eso es precisamente lo que Arnais, ya sabes, vino a diagnosticar. Y eso es lo que yo capté: que, de alguna manera, hemos perdido el interés por el significado de las palabras. Y hemos empezado a adoptar esas narrativas extrañas y simplistas que, en realidad, refuerzan el poder de determinados imperios y de determinados intereses capitalistas.

Vale. Entonces, ¿en qué punto estamos ahora? Si, en el idioma inglés, adoptaras un enfoque lingüístico muy sencillo —y yo diría que quizá estúpido, precisamente por lo sencillo que es— para analizar los adjetivos, ¿verdad? Obviamente, modificamos las palabras de forma diferente. Atribuimos significado a eso que llamamos democracia sin siquiera utilizar la palabra. Así que es una forma muy, muy limitada de abordar la diversidad conceptual.
...
**Jean-Paul:** Sí. Bueno, quiero decir que tienes toda la razón, Olivier, en esa línea de pensamiento. Fueron Eva Crick y Norma Ulstaba Kaufman, si no recuerdo mal, quienes se mostraron muy activas al respecto hace unos años, diciendo que, si tenemos estas limitaciones, nuestro único recurso es intentar asociarnos, encontrar a otras personas en el mundo interesadas en hacer cosas similares e intentar diseñar algún tipo de enfoque de ciencia ciudadana en este ámbito.

Así que estamos en ese proceso. Las ideas, por el momento, consisten en intentar colaborar con la Comisión Europea para conseguir una financiación básica que permita desarrollar un enfoque basado en la ciencia ciudadana. Quiero decir, podríamos decir que podríamos crear algo de naturaleza bastante democrática, o al menos que se ajuste a cierto sentido de la democracia, para empezar a producir esto, el contenido de esta página web que, por así decirlo, es de nuestra propiedad, entre comillas, llamémoslo así.

O si vas allí, no verás nada. No hay nada. No está activo. Solo lo tenemos como algo que usar en el futuro. Pero la idea es que, con suerte, podamos empezar con algunos idiomas, quizá uno de cada gran centro poblado o subregión a nivel mundial, y colaborar con socios locales para recopilar estos diferentes artefactos lingüísticos.

Los tratamos como si fueran fragmentos de cerámica, y luego intentamos crear archivos en torno a ellos y tratar de entender de dónde proceden estas cosas: qué tierra, qué gente vivía en esas tierras, en qué contexto, por qué razones y, en última instancia, ¿son ideas viables? Ya sabes, esa fue una de las principales críticas al principio de este proyecto. Bastantes personas han dicho: «Esto es una locura». Ya sabes, yo diría que podría ser un proceso de deliberación en sí mismo.
